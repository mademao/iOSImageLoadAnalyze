...
- (void)step:(CADisplayLink *)link {
    ...
    if (NSClassFromString(@"SGIGifImage")) {
        LOCK(
             UIImage *img = [image animatedImageFrameAtIndex:nextIndex];
             _curFrame = img.yy_imageByDecoded;
             [self willChangeValueForKey:@"currentAnimatedImageIndex"];
             _curIndex = nextIndex;
             [self didChangeValueForKey:@"currentAnimatedImageIndex"];
...
//             [UIImagePNGRepresentation(img) writeToFile:[NSString stringWithFormat:@"/Users/mademao/Desktop/temp/%@.png", @(_curIndex)] atomically:YES];
